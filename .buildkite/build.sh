...
BUILD_CONTAINER="build-${BUILDKITE_JOB_ID}-${ARCH}"
...
echo "--- Running tests ..."
TEST_IMAGE="test-${BUILDKITE_JOB_ID}-${ARCH}"
...
DEBIAN_FRONTEND=noninteractive dpkg -i ../build-focal/{gdal-bin,gdal-data,libgdal,python3-gdal}*.deb
